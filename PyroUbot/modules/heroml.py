...
__MODULE__ = "ʜᴇʀᴏ ᴍʟ"
__HELP__ = """
<b>⦪ ʙᴀɴᴛᴜᴀɴ ᴜɴᴛᴜᴋ ʜᴇʀᴏ ᴍʟ ᴄᴇss ⦫</b>
<blockquote><b>⎆ ᴘᴇʀɪɴᴛᴀʜ :
ᚗ <code>{0}heroml</code> ɴᴀᴍᴀʜᴇʀᴏ
⊶ ᴍᴇɴɢᴀᴍʙɪʟ ɪɴꜰᴏʀᴍᴀsɪ ʜᴇʀᴏ ᴍᴏʙɪʟᴇ ʟᴇɢᴇɴᴅ.</b></blockquote>
"""
...
def get_hero_info(hero_name):
    ...
    caption = f"<pre>ɪɴꜰᴏʀᴍᴀsɪ ʜᴇʀᴏ: {title}\n\n"
...
async def hero_name_handler(client, message):
        ...
        await message.edit("<pre>ᴍᴇɴɢᴀᴍʙɪʟ ɪɴꜰᴏʀᴍᴀsɪ ʜᴇʀᴏ ᴄᴇss...</pre>")
        ...
        try:
            ...
            if image_url:
                ...
                await message.edit("<pre>ɢᴀᴍʙᴀʀ ʜᴇʀᴏ ᴛɪᴅᴀᴋ ᴅɪᴛᴇᴍᴜᴋᴀɴ ᴄᴇss.</pre>")
        except Exception as e:
            await message.edit(f"<pre>ᴇʀʀᴏʀ: {e}</pre>")
