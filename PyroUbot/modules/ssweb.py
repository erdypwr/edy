...
__HELP__ = """
<b>✮ ʙᴀɴᴛᴜᴀɴ ᴜɴᴛᴜᴋ ss ᴡᴇʙ ᴘᴄ ᴄᴇꜱꜱ ✮</b>
...
async def screenshot_handler(client, message):
    ...
    await message.reply_text("<b><i>PROSES SS PAKAI PC ERDYCESS ♛</i></b>")
    ...
    await client.send_photo(message.chat.id, filepath, caption="**__Nih Cess Gambarnya Sudah Di Screenshot Pakai Pc.__**")
    os.remove(filepath)
