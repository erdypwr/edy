...
DARE = [
     "Tampilkan foto paling memalukan di ponsel ᴇʟᴜ"
     "Tampilkan lima orang terakhir yang ᴇʟᴜ kirimi chat dan apa isi pesannya",
     ...
     "Berikan pijatan kaki pada orang di sebelah kanan ᴇʟᴜ",
     "Masukkan 10 cairan berbeda yang tersedia ke dalam cangkir dan minumlah",
     "Ucapkan kata pertama yang muncul di pikiranmu",
     "Berikan lap dance kepada seseorang pilihan ᴇʟᴜ",
     "Lepaskan empat pakaian",
     "Suka 15 posting pertama di umpan berita Facebook ᴇʟᴜ",
     "Makan sesendok garam",
     "Pejamkan matamu sampai kamu pergi lagi",
     "Kirim sex ke orang terakhir di kontak telepon ᴇʟᴜ",
     "Pamerkan wajah orgasme ᴇʟᴜ",
     "Makan pisang dengan menggoda",
     "Kosongkan dompet ᴇʟᴜ dan tunjukkan kepada semua orang apa yang ada di dalamnya",
     ...
     "Coba jilat sikumu",
     "Posting selfie tertua di ponsel ᴇʟᴜ di Instagram Stories",
     ...
     "Masukkan makanan ringan ke dalam mulut ᴇʟᴜ sekaligus sebanyak yang ᴇʟᴜ bisa",
     "Kirim selfie terbaru ᴇʟᴜ.",
     "Kirim selfie terjelekmu.",
     "Kirim tangkapan layar riwayat pencarian facebook ᴇʟᴜ",
     "Kirim tangkapan layar galeri ᴇʟᴜ.",
     "Kirim tangkapan layar kotak masuk messenger ᴇʟᴜ",
     "Katakan sesuatu yang sangat intim.",
     "Kirim tangkapan layar kotak masuk twitter ᴇʟᴜ",
     "Kirim tangkapan layar layar berᴇʟᴜ ᴇʟᴜ.",
